...
// @TODO: (new Date).toLocaleDateString('ja-jp', {timeZone: 'America/New_York', year: 'numeric', month: 'numeric', day: 'numeric', hour: '2-digit', minute: 'numeric', second: 'numeric'})
...
(function() {
    ...
    var $$; /* document.querySelectorAll へのショートハンド(配列に変換済み) */

    // start 
    TumblrTornado_Core();
    TumblrTornado_Around();
    TumblrTornado_SITEINFO();
    TumblrTornado_Custom();
    TumblrTornado_View();
    TumblrTornado_Boot();
    ...
    function TumblrTornado_Around() {
        ...
        /** value の取りうる上限、下限を決めて外れていた場合に寄せます **/
        Etc.intRange = function intRange(min, value, max) {
            return Math.min(Math.max(value, min), max);
        }
    
        /** 配列の old_index を new_index に差し替えた新しい変数を返します */
        Array.prototype.move = function(old_index, new_index) {
            ...
            old_index = Etc.intRange(0, old_index, this.length);
            new_index = Etc.intRange(0, new_index, this.length);
    ...
    function TumblrTornado_SITEINFO() { }

    function TumblrTornado_Custom() { }
    function TumblrTornado_View() { }
    function TumblrTornado_Boot() { }
        ...
        Tornado.windows.tornado_config = function tornado_config(e) {
            ...
            Vals.oauth_operator.tumblelog_infos.map(function(tumblelog_info, i) {
                ...
                button_above.addEventListener('click', function(e) {
                    ...
                    Vals.oauth_operator.tumblelog_infos = Vals.oauth_operator.tumblelog_infos.move(i, i - 1);
